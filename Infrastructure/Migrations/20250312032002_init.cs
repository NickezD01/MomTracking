        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthMetrics_Childrens_ChildrentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrowthIndices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GrowthIndices_HealthMetrics_HealthMetricId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_Users_UserAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GrowthIndices_HealthMetricId",
                table: "GrowthIndices",
                column: "HealthMetricId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HealthMetrics_ChildrentId",
                table: "HealthMetrics",
                column: "ChildrentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_UserAccountId",
                table: "Payments",
